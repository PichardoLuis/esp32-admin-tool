...
void InitServer(){
    ...
    server.serveStatic("/www/get_slider.js", SPIFFS, "/www/get_slider.js").setDefaultFile("www/get_slider.js").setCacheControl("max-age=600");
    ...
    server.serveStatic("/www/rangeslider.css", SPIFFS, "/www/rangeslider.css").setDefaultFile("www/rangeslider.css").setCacheControl("max-age=600");    
